...
# 1. 需要先运行的脚本路径
BASE_DIR = r"S:\04.FA\03.CIM\09.个人文件\刘欢\auto_reporter"


SCRIPT_1 = fr'"{BASE_DIR}\1_FP2FileServer-REconnect.bat"'
SCRIPT_2 = fr'"{BASE_DIR}\acf_cf_cell_excel_stat\bat\startup.bat"'
SCRIPT_4 = fr'"{BASE_DIR}\file_excel_stat\bat\startup.bat"'
...
# 5.日志配置
log_filename = f"excel_process_{datetime.now().strftime('%Y%m%d_%H%M')}.log"
logging.basicConfig(
    level=logging.INFO,
